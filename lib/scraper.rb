...
class Scraper
  ...
  def self.scrape_profile_page(profile_url)
    ...
    student_profile[:profile_quote] = doc.css(".main-wrapper.profile .vitals-text-container .profile-quote").text
    student_profile[:bio] = doc.css(".main-wrapper.profile .description-holder p").text
